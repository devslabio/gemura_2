...
export default function LoanRepaymentsReportPage() {
  ...
  if (loading && rows.length === 0) {
    return (
      <PlatformDrilldownShell title="Loan repayments" backHref={backHref}>
  ...
  return (
    <PlatformDrilldownShell title="Loan repayments (period)" periodLabel={periodLabel} backHref={backHref}>
      {error ? (
