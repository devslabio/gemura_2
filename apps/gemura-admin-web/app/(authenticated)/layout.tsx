...
import { DashboardPeriodProvider } from '@/app/(authenticated)/admin/dashboard/dashboard-period-context';
...
export default function AuthenticatedLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-gray-100 text-sm text-gray-600">Loading…</div>}>
